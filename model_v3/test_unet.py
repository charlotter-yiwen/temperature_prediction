...
sys.path.insert(0, os.path.join(TP_DIR, "model_v3_variants", "unet_decoder"))
from model_unet import SetFNOModelUNet
...
if __name__ == "__main__":
    model_path = os.path.join(MODEL_DIR, "results_unet_decoder", "unet_decoder_phase2.pth")
    model, scaler_y_mean, scaler_y_scale, norm_info = load_unet_model(model_path)
